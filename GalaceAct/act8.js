const favSingers =[ 'SZA', 'Daniel Ceasar', 'Frank Ocean' ];
...
const favNumbers = [ '111', '222', '444', '888'];
...
console.log ( favSingers [0], favSingers [1], favSingers[2], favNumbers [1], mixedArr [3]);